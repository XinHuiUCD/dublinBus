...
*****************************************************************************/
let t=Symbol("map"),u=Symbol("api"),w=Symbol("marker"),x=Symbol("markerCluster"),y=Symbol("CustomMarker"),z=Symbol("mapTilesLoaded"),A="click dblclick drag dragend dragstart mousedown mousemove mouseout mouseover mouseup rightclick".split(" ");
...
toRef(a,b));watch([()=>a.center,()=>a.zoom,...f],([a,b],[c,d])=>{var f,g,m;const {center:h,zoom:k,...n}=l();null===(f=e.value)||void 0===f?void 0:f.setOptions(n);void 0!==b&&b!==d&&(null===(g=e.value)||void 0===g?void 0:g.setZoom(b));b=!c||a.lng!==c.lng||a.lat!==c.lat;a&&b&&(null===(m=e.value)||void 0===m?void 0:m.panTo(a))})};onMounted(()=>{if(a.apiPromise&&a.apiPromise instanceof Promise)a.apiPromise.then(h);else{try{const {apiKey:b,region:c,version:d,language:e,libraries:f}=a;D=new C({apiKey:b,
...
var fa=defineComponent({name:"Marker",props:{options:{type:Object,required:!0}},emits:I,setup(a,{emit:b,expose:c,slots:d}){a=toRef(a,"options");b=H("Marker",I,a,b);provide(w,b);c({marker:b});return()=>{var a;return null===(a=d.default)||void 0===a?void 0:a.call(d)}}}),ha=defineComponent({name:"Polyline",props:{options:{type:Object,required:!0}},emits:A,setup(a,{emit:b}){a=toRef(a,"options");return{polyline:H("Polyline",A,a,b)}},render:()=>null}),ia=defineComponent({name:"Polygon",props:{options:{type:Object,
required:!0}},emits:A,setup(a,{emit:b}){a=toRef(a,"options");return{polygon:H("Polygon",A,a,b)}},render:()=>null});let J=A.concat(["bounds_changed"]);var ja=defineComponent({name:"Rectangle",props:{options:{type:Object,required:!0}},emits:J,setup(a,{emit:b}){a=toRef(a,"options");return{rectangle:H("Rectangle",J,a,b)}},render:()=>null});let K=A.concat(["center_changed","radius_changed"]);
...
let La=withScopeId("data-v-b9d5ec8a")(a=>a.hasSlotContent?(openBlock(),createBlock("div",{key:0,ref:"customMarkerRef",class:"custom-marker-content",style:{cursor:a.$attrs.onClick?"pointer":void 0}},[renderSlot(a.$slots,"default",{},void 0,!0)],4)):createCommentVNode("v-if",!0));Z.render=La;Z.__scopeId="data-v-b9d5ec8a";
